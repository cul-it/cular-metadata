...
| `source_path`  | not-allowed         | not-allowed       | Location of package files in source data. Initially left blank in ingest manifest, populated using preingest code, but not retained in storage manifest. |
